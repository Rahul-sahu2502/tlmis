...
<script>
    $(document).ready(function() {
        ...
        function fetchIssuerTypes() {
            $.ajax({
                url: "<?php echo e(route('master_get',['key' => $key])); ?>",
                method: "GET",
        ...
        $('#masterForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('master_store',['key' => $key])); ?>",
                method: 'POST',
                data: formData,
                success: function(response) {
                    $('#masterForm')[0].reset();
        ...
        $('body').on('click', '.editBtn', function() {
            var id = $(this).data('id');
            $.get("<?php echo e(url('master-edit')); ?>/<?php echo e($key); ?>/" + id, function(data) {
        ...
        $('body').on('click', '.deleteBtn', function() {
            SwalWithCustomSettings.fire({
                ...
                if (result.isConfirmed) {
                    var id = $(this).data('id');
                    $.ajax({
                        url: "<?php echo e(url('master-destroy')); ?>/<?php echo e($key); ?>/" + id,
                        method: 'DELETE',
                        data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\php\vectreProjects\tlmis\resources\views\masters\types.blade.php ENDPATH**/ ?>