        ...
        function change_status(sts_data){
            SwalWithCustomSettings.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('task_sb_change_status')); ?>", // Route to the controller
                        type: "post",
                        headers: {
...
<?php /**PATH C:\wamp64\www\php\vectreProjects\tlmis\resources\views\tasks\sb_request_list_js.blade.php ENDPATH**/ ?>