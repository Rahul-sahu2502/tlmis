...
<script>
    $(jQuery).ready(function() {
        ...
        function get_list(sData={}){
            ...
            $.ajax({
                url: "<?php echo e(route('offices_task_report_ajax')); ?>",
                type: "POST",
                headers: {
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_projects\TLMIS original code\TLMIS\resources\views/tasks/reports/office_wise_report.blade.php ENDPATH**/ ?>