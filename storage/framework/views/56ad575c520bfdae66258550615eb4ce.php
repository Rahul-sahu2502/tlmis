...
<body data-bs-spy=scroll data-bs-target=#navbar-example>
        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id=navbar>
            <div class=container>
                ...
                <div class="collapse navbar-collapse" id=navbarSupportedContent>
                    ...
                    <div class="ms-lg-3">
                        <a href="<?php echo e(route('sign-in')); ?>" class="btn btn-primary">Sign in</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class=container>
                ...
                <div class=col-lg-4>
                        <div class="d-flex p-3">
                            ...
                            <animated-icons
                                src="<?php echo e(asset('assets/images/icon-1.json')); ?>"
                                trigger="loop"
                    ...
                    <div class=col-lg-4>
                        <div class="d-flex p-3">
                            <div class="flex-shrink-0 me-3">
                            <animated-icons
                                src="<?php echo e(asset('assets/images/icon-2.json')); ?>"
                                trigger="loop"
                                attributes='{"variationThumbColour":"#536DFE","variationName":"Two Tone","variationNumber":2,"numberOfGroups":2,"backgroundIsGroup":false,"strokeWidth":1,"defaultColours":{"group-1":"#000000","group-2":"#536DFE","background":"#FFFFFF"}}'
                                height="100"
                                width="100"
                    ...
                    <div class=col-lg-4>
                        <div class="d-flex p-3">
                            <div class="flex-shrink-0 me-3">
                            <animated-icons
                                src="<?php echo e(asset('assets/images/icon-3.json')); ?>"
                                trigger="loop"
    ...
    <script src="<?php echo e(asset('assets/js/pages/landing.init.js')); ?>"></script>
    <script src="https://animatedicons.co/scripts/embed-animated-icons.js"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\laravel_projects\TLMIS original code\TLMIS\resources\views/welcome.blade.php ENDPATH**/ ?>