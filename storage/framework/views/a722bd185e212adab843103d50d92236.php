...
<?php $__env->startSection('content'); ?>
    <div class="col-lg-6">
        <div class="card mt-4">
            <div class="card-body p-4">
                <div class="text-center mt-2">
                    <h5 class=text-primary><?php echo e(__('word.login_title')); ?>!</h5>
                    <p class=text-muted><?php echo e(__('word.login_sub_title')); ?></p>
                </div>
                <div class="p-2 mt-4">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('validate-login')); ?>" id="frm_signin" method=post>
                        <?php echo csrf_field(); ?>
                        <?php if($errors->any()): ?>
                            <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center mb-2"
                                ...
                                </i> <?php echo implode('', $errors->all('<div>:message</div>')); ?>
                        ...
                        <?php endif; ?>
                        <div class=mb-3>
                            <label for=username class=form-label><?php echo e(__('word.username')); ?></label>
                            <input type=text class=form-control name="username" id=username placeholder="<?php echo e(__('word.enter_username')); ?>"
                                required="" autofocus>
                            <span class="error"></span>
                        </div>
                        <div class=mb-3>
                            <div class=float-end>
                                <a href="<?php echo e(route('forgot-password')); ?>" class=text-muted><?php echo e(__('word.forgot_password')); ?></a>
                            </div>
                            <label class=form-label for=password-input><?php echo e(__('word.password')); ?></label>
                            <div class="position-relative auth-pass-inputgroup mb-3">
                                <input type=password class="form-control pe-5 password-input" placeholder="<?php echo e(__('word.enter_password')); ?>"
                        ...
                        <div class=mb-3>
                            ...
                            <div class="d-flex align-items-center justify-content-center cap-pass-input-group mb-3">
                                <p class="svg-img captcha m-0">
                                    <span>
                                        <img src="<?php echo e(route('generate-captcha', ['length' => 4])); ?>"
                        ...
                        <div class=form-check>
                            ...
                            <label class=form-check-label for=auth-remember-check><?php echo e(__('word.remember_me')); ?></label>
                        </div>
                        
                        <div class=mt-4>
                            <button class="btn btn-success w-100" type=button id="btn_signin"><?php echo e(__('word.login_button')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="m-4 text-center">
            <p class=mb-0>Don't have an account ? <a href="<?php echo e(route('sign-up')); ?>"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function refreshCaptcha() {
            ...
            fetch("<?php echo e(route('generate-captcha', ['length' => 4])); ?>")
                .then(response => {
                    if (!response.ok) {
...
<?php echo $__env->make('layouts.layout_auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_projects\TLMIS original code\TLMIS\resources\views/auth/sign_in.blade.php ENDPATH**/ ?>