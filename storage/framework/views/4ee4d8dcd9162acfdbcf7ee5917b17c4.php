                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="aavak_no" name="aavak_no"
                                                   value="<?php echo e(@$editItem->aavak_no); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control normal-text" id="aavak_date"
                                                   name="aavak_date"
                                                   value="<?php echo e(@$editItem->aavak_date && strtotime($editItem->aavak_date) ? @$editItem->aavak_date : ''); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="prishthiy_no"
                                                   name="prishthiy_no"
                                                   value="<?php echo e(@$editItem->prishthiy_no); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control normal-text" id="prishthiy_date"
                                                   name="prishthiy_date"
                                                   value="<?php echo e(@$editItem->prishthiy_date && strtotime($editItem->prishthiy_date) ? @$editItem->prishthiy_date : ''); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="header_id" id="header_id" class="form-control">
                                                ...
                                                <?php if(@$headerList): ?>
                                                    <?php $__currentLoopData = $headerList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $sel = (@$editItem->header_id == $value->id) ? 'selected' : '';
                                                        ?>
                                                        <option
                                                            value="<?php echo e($value->id); ?>" <?php echo e($sel); ?>><?php echo e($value->header_name); ?>
                                            ...
                                            <textarea name="header" id="header" rows="5"
                                                      class="form-control ckeditor"><?php echo e(@$editItem->header); ?></textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="prati_id" id="prati_id" class="form-control">
                                                <option value="">-- चुने --</option>
                                                <?php if(@$masterPratiList): ?>
                                                    <?php $__currentLoopData = $masterPratiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value->id); ?>"><?php echo e($value->designation); ?>
                                            ...
                                            <textarea name="letter_for" id="letter_for" rows="5"
                                                      class="form-control ckeditor"><?php echo e(@$editItem->letter_for); ?></textarea>
                                            <small class="error"></small>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subject" name="subject"
                                                   placeholder="विषय दर्ज करें" value="<?php echo e(@$editItem->subject); ?>">
                                            <small class="error"></small>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="sandarbh" id="sandarbh" rows="5"
                                                      ...
                                                      placeholder="सन्दर्भ दर्ज करें"><?php echo e(@$editItem->sandarbh); ?></textarea>
                                            <small class="error"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="main_content" rows="10" id="main_content" cols="6"
                                                      class="form-control ckeditor normal-text"
                                                      placeholder="मुख्य सामग्री दर्ज करें"><?php echo e(@$editItem->main_content); ?></textarea>
                                            <small class="error"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="pratilipi" rows="10" id="pratilipi" cols="6"
                                                      class="form-control ckeditor normal-text"
                                                      placeholder="प्रतिलिपि"><?php echo e(@$editItem->pratilipi); ?></textarea>
                                            <small class="error"></small>
                                        </div>
                                    </div>
                                                ...
                                                <?php if(@$signatoryList): ?>
                                                    <?php $__currentLoopData = $signatoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <option value="<?php echo e($value->id); ?>" <?php echo e($sel); ?>>
                                                            <?php echo e($value->signatory . ' (' . $value->officer_name . ')'); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/custom/textconvertor.js')); ?>"></script>
    <script>
        ...
        $(document).on('submit', '#letterForm', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url("submit-letter-detail")); ?>',
                type: "POST",
                data: form,
                contentType: false,
                cache: false,
                ...
                success: function (response) {
                    if (response.status == 'success') {
                        Swal.fire("Great!", response.msg, "success").then(function () {
                            ...
                            if (from == 'invoice') {
                                location.href = '<?php echo e(url("view-letter/")); ?>' + response.id;
                            } else {
                                location.href = '<?php echo e(url("create-letter")); ?>';
                            }
                        });
        ...
        $(document).on('change', '#prati_id', function () {
            ...
            $.ajax({
                url: '<?php echo e(url("get-prati-detail")); ?>',
                type: "GET",
                data: {
                    prati_id: prati_id
                },
        ...
        $(document).on('change', '#header_id', function () {
            ...
            $.ajax({
                url: '<?php echo e(url("get-header-detail")); ?>',
                type: "GET",
                data: {
                    header_id: header_id
                },
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_projects\TLMIS original code\TLMIS\resources\views/letters/add.blade.php ENDPATH**/ ?>