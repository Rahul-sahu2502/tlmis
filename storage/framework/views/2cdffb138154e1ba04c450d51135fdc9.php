            ...
            $.ajax({
                ...
                success: function(rating_data) {
                    ...
                    rating_data.forEach((value, index) => {
                        ...
                        let roundedAvg = Math.round(avgRating);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_projects\TLMIS original code\TLMIS\resources\views/performance/rating.blade.php ENDPATH**/ ?>