                        ...
                        <div class=card-body>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h4 class="fs-4 flex-grow-1 mb-0"><span class=counter-value data-target="{{$data[0]->total_task}}">{{$data[0]->total_task}}</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=card-body>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <h4 class="fs-4 flex-grow-1 mb-0"><span class=counter-value data-target="{{$data[0]->total_users}}">{{$data[0]->total_users}}</span></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=card-body>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class=counter-value data-target="{{$data[0]->pending_from_admin}}">{{$data[0]->pending_from_admin}}</span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class=col-xl-6>
                <div class=card>
                    <div class="card-header border-0 align-items-center d-flex">
                        ...
                        <div>
                            <a href="{{route('task_view')}}" class="btn btn-soft-secondary btn-sm">
                                View All
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row g-0 text-center">
                            <div class="col-6 col-sm-4">
                                <div class="p-2 border border-dashed border-start-0">
                                    <h5 class="mb-1 text-primary"><span class=counter-value data-target="{{$data[0]->total_task}}">{{$data[0]->total_task}}</span></h5>
                                    <p class="text-muted mb-0">Active Tasks</p>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="p-2 border border-dashed border-start-0">
                                    <h5 class="mb-1 text-warning"><span class=counter-value data-target="{{$data[0]->inprogress_task}}">{{$data[0]->inprogress_task}}</span></h5>
                                    <p class="text-muted mb-0">In Progress Tasks</p>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4">
                                <div class="p-2 border border-dashed border-start-0 border-end-0">
                                    <h5 class="mb-1 text-success"><span class=counter-value data-target="{{$data[0]->completed_task}}">{{$data[0]->completed_task}}</span></h5>
                    ...
                    <div class="card-body p-0 pb-2">
                        <div>
                            <div id=tasks-overview data-vals='["{{$data[0]->total_task}}","{{$data[0]->inprogress_task}}","{{$data[0]->completed_task}}"]' class=apex-charts dir=ltr></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class=card>
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div><a href="{{route('tl_view')}}" class="btn btn-soft-secondary btn-sm">View All</a></div>
                    </div>
                    <div class="card-body min-card-height pt-1">
                        @forelse($tlReviews as $review)
                        <a href="{{ url('tl-detail?var=' . base64_encode($review->id)) }}">
                            <div class="mini-stats-wid d-flex align-items-center border-bottom-dashed border-1 border-default mt-4 p-1">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1">{{ $review->tl_title }}</h6>
                                    <p class="text-muted mb-0">{{ \Carbon\Carbon::parse($review->tl_date)->format('d M, Y') }}</p>
                                </div>
                                <div class="flex-shrink-0">
                                    <p class="text-muted mb-0">{{ \Carbon\Carbon::parse($review->tl_time)->format('h:i A') }}</p>
                                </div>
                            </div>
                        </a>
                        @empty
                                    ...
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            <div class="mt-3">
                                                ...
                                                <a href="{{route('tl_new')}}" class="btn btn-success">Create One</a>
                                                @else
