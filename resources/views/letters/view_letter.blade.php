                                ...
                                @if (@$letterDetail && $letterDetail)
                                    <div id="printableDiv">
                                        ...
                                        <div class="mt-0 header body-text">
                                            <span class="normal-text">क्रमांक / {!! $letterDetail->aavak_no
                                                ? $letterDetail->aavak_no
                                                : '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' !!} / मबावि / सा.वि. /
                                                2024-25</span>

                                            <span id="address" class="normal-text">नवा रायपुर, अटल नगर, दिनांक
                                                {!! strtotime($letterDetail->aavak_date) > 0 ? date('d-m-Y', strtotime($letterDetail->aavak_date)) : '' !!}</span>
                                        </div>

                                        <div class="mt-3 body-text" id="prati">
                                            <span class="normal-text">प्रति,</span>
                                            <div class="ml-5 normal-text">{!! $letterDetail->letter_for !!}</div>
                                        </div>

                                        <div class="mt-3 body-text" id="#subject">
                                            <div class="fw-bold normal-text">विषय:- {!! $letterDetail->subject !!}</div>
                                        </div>

                                        @if ($letterDetail->sandarbh)
                                            <div class="mt-3 sandarbh body-text">
                                                <span class="normal-text">सन्दर्भ:-</span>
                                                <span>{!! $letterDetail->sandarbh !!}</span>
                                            </div>
                                        @endif

                                        <div class="mt-3 body-text">
                                            <div class="text-justify">{!! $letterDetail->main_content !!}</div>
                                        </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="25%" class="text-center">
                                                        <div class="fw-bold normal-text">({{ $letterDetail->officer_name }})
                                                            <br>
                                                            {{ $letterDetail->signatory_name }}
                                                        </div>
                                        ...
                                        <div class="mt-3 body-text">
                                            <span class="normal-text">क्रमांक / {!! $letterDetail->prishthiy_no
                                                ...
                                                अटल
                                                नगर, दिनांक
                                                {{ strtotime($letterDetail->prishthiy_date) > 0 ? date('d-m-Y', strtotime($letterDetail->prishthiy_date)) : '' }}</span>
                                        </div>

                                        @if ($letterDetail->pratilipi)
                                            <div class="mt-3 lh body-text">
                                                <div class="fw-bold normal-text">प्रतिलिपि:-</div>
                                                <div class="ml-5">{!! $letterDetail->pratilipi !!}</div>
                                            </div>
                                        @endif
                                        ...
                                        <table width="100%" class="signatory body-text">
                                            <tbody>
                                                <tr>
                                                    <td colspan="3" width="75%"></td>
                                                    <td width="25%" class="text-center">
                                                        <div class="fw-bold normal-text">{{ $letterDetail->signatory_name }}
                                                        </div>
                                                        <span class="normal-text">महिला एवं बाल विकास विभाग <br>नवा रायपुर,
                                                            छत्तीसगढ़</span>
                                                    </td>
                                    ...
                                    <div class="text-center">
                                        <a href="{{ url('create-letter/'.$letterDetail->id.'?from=invoice') }}" class=" btn btn-info btn-sm mt-3 text-center normal-text mr-3"><i class="mdi mdi-pencil"></i>
                                            Edit</a>
