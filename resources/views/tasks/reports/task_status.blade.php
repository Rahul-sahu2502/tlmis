...
<div class=col-lg-12>
    <div class=card id=tasksList>
        ...
        <div class="card-body border border-dashed border-end-0 border-start-0" @if($search==4) style='display:none' @endif >
            <form>
                <div class="row g-3">
                    ...
                    <div class="col-xxl-3 col-sm-4" @if($search!=1) style='display:none' @endif>
                    ...
                    <div class="col-xxl-3 col-sm-4" @if($search!=2) style='display:none' @endif >
                        <div class=input-light>
                            <label>Days</label>
                            @php
...
<script>
    $(jQuery).ready(function() {
        ...
        let search={'sts':'{{ $sts }}','d':'{{ $dept }}'};
        $('#filter').click(function(){
            let sts=false;
            search={'sts':'{{ $sts }}','d':'{{ $dept }}'};
            if($("#idStatus").val()!=""){
